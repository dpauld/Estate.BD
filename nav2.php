    ...
    <div class="nav-wrapper container">
        <div class="">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><input type="text" id="autocomplete-input" class="autocomplete purple-text text-darken-4" name="search" placeholder="&#xF002; search again" style="font-family:Arial, FontAwesome; margin-bottom: 10px;" ></li>
                <?php if ($inSession) { ?>
                <li>
