...
$Sql = "SELECT * FROM " . $_q1 . " WHERE id = " . $_q2;
                        ...
                        <div class="section">
                            ...
                            <div class="row">
                                ...
                                <div class="col l7 m7 s12 offset-l2">
                                    ...
                                    <form id="addFRM" class="col s12" method="post" action="propUpScript.php">

                                        <div class="row">
                                            <!--offerType-->
                                            <div class="input-field col s6">
                                                <select id="offerType" class="" name="offerType">
                                                    <option value="" disabled <?= $rows['property_condition'] == '' ? ' selected="selected"' : ''; ?> >Select Offer Type *</option>
                                                    <option value="rent" <?= $rows['property_condition'] == 'rent' ? ' selected="selected"' : ''; ?> >Rent</option>
                                                    <option value="sale" <?= $rows['property_condition'] == 'sale' ? ' selected="selected"' : ''; ?> >Sale</option>
                                                </select>
                                            </div> 
                                            <!--catagory-->
                                            <div class="input-field col s6">
                                                <select id="category" class="" name="category">
                                                    <option value="" disabled <?= $rows['type'] == '' ? ' selected="selected"' : ''; ?> >Select Property Type *</option>
                                                    <option value="apartment" <?= $rows['type'] == 'apartment' ? ' selected="selected"' : ''; ?> >Apartment</option>
                                                    <option value="house" <?= $rows['type'] == 'house' ? ' selected="selected"' : ''; ?> >House</option>
                                                    <option value="office" <?= $rows['type'] == 'office' ? ' selected="selected"' : ''; ?> >Office</option>
                                                    <option value="shop" <?= $rows['type'] == 'shop' ? ' selected="selected"' : ''; ?> >Shop</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="price" type="text" class="validate" name="price" value="<?php echo $rows['price']; ?>">
                                                <label for="price"><i class="fa fa-lg fa-money" aria-hidden="true"></i>&nbsp;&nbsp;Price(bdt)</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id ="available_from" class="datepicker" type="date" name="available_from" value="<?php echo $rows['available_from']; ?>" min=<?php echo date("Y-m-d"); ?>>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="district" type="text" class="validate" name="district" value="<?php echo $rows['district']; ?>">
                                                <label for="district">District *</label>                                        
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="area" type="text" class="validate" name="area" value="<?php echo $rows['area']; ?>">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="fullAddress" type="text" class="validate" name="fullAddress" value="<?php echo $rows['fullAddress']; ?>">
                                        ...
                                        <div class="input-field col s12" style="border: 1px solid #4a148c; margin-bottom: 2.25rem;">
                                            ...
                                            <input id="location" type="text" class="validate" style="margin-top: 3%;" name="location" value="<?php echo $rows['location']; ?>">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="beds" type="number" class="validate" name="beds" value="<?php echo $rows['beds']; ?>">
                                                <label for="beds"><i class="fa fa-lg fa-bed" aria-hidden="true"></i>&nbsp;&nbsp;Bedrooms</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="baths" type="number" class="validate" name="baths" value="<?php echo $rows['baths']; ?>">
                                                <label for="baths"><i class="fa fa-lg fa-bath" aria-hidden="true"></i>&nbsp;&nbsp;Bathrooms</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="ttlrooms" type="number" class="validate" name="ttlrooms" value="<?php echo $rows['rooms']; ?>">
                                                <label for="ttlrooms">Total Rooms (unit) </label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="ttlarea" type="number" class="validate" name="ttlarea" value="<?php echo $rows['size']; ?>">
                                                <label for="ttlarea">Total Area (sq. ft) *</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="floor" type="number" class="validate" name="floor" value="<?php echo $rows['floor']; ?>">
                                                <label for="floor">Floor No.</label>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 38%;">
                                            <div class="input-field col s12">
                                                <textarea id="propDetails" class="materialize-textarea" name="propDetails"><?php echo $rows['details']; ?></textarea>
                                                <label for="propDetails"><i class="fa fa-lg fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;More About the Property</label>
                                            </div>
                                        </div>
                                        <input id="hdnImgZ" type="text" name="mediaZ" value="<?php echo $rows['img']; ?>" hidden>
                                        <input id="hdnId" type="text" name="hdnId" value="<?php echo $rows['id']; ?>" hidden>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <button id="addSB" class="btn waves-effect waves-light purple accent-2" type="submit" name="update">
                                                    Update / Save
                                                </button>
                                            </div>
                                        </div>
...
//                },
        ...
        <script type="text/javascript">
            (function ($) {
                $(function () {
                    $('#propDetails').trigger('autoresize');
