        ...
        <script>
            ...
            (function ($) {
                $(function () {
                    ...
                    mFilterZ(cat);
                    districtOpt(cat, dis);
                    areaOpt($('#category').val(), dis);
                    $('select').material_select();
                    showList(cat, dis, $('#area').val(), 0, 50000);
                    ...
                    $('#bed').on('change', function () {
                        showList($('#category').val(), $('#district').val(), $('#area').val(), faultz0, faultz1, this.value, $('#bath').val(), $('#park').val());
                    });
                    $('#bath').on('change', function () {
                        showList($('#category').val(), $('#district').val(), $('#area').val(), faultz0, faultz1, $('#bed').val(), this.value, $('#park').val());
                    });
                    $('#park').on('change', function () {
                        showList($('#category').val(), $('#district').val(), $('#area').val(), faultz0, faultz1, $('#bed').val(), $('#bath').val(), this.value);
                    });
...
//                if(catZ == 'apartment'){$('#forAppZ').show();}
