    ...
    <div class="nav-wrapper container">
        <div class="">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="properties.php" class="purple-text text-accent-2">Property Posts</a></li>
                <li><a href="propfairList.php" class="purple-text text-accent-2">Fair</a></li>
                <?php if ($inSession) { ?>
                <li>
                ...
                <?php } else { ?>
                    ...
                    <li>
                        <a href="Admin/login.php" class="logg purple-text text-accent-2" >
                            <span style="padding: 3px;border: 1px solid #e040fb;">
                                Admin Login
                            </span>
                        </a>
